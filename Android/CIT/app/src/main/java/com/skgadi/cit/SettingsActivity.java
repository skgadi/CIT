...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class SimulationFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("sim_vel_observer_beta_0"));
            bindPreferenceSummaryToValue(findPreference("sim_vel_observer_beta_1"));
            bindPreferenceSummaryToValue(findPreference("sim_vel_observer_beta_2"));
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class GraphFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_graphs);
            setHasOptionsMenu(true);
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class BridgeFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_bridge);
            setHasOptionsMenu(true);
